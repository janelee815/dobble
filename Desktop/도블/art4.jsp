...
<body>
  <div>
    <section id = "qna">
      ...
      <div>
<h1 class="mx-auto mt-5 pt-4 px-4 py-4">�ܹ��� �����ұ��?</h1></div>
<form action="${contextPath}/clubreco/surveysubmit9" method="post">
<div id="answer" class="mx-auto mt-5 pt-5 px-5 py-5" >
<input type="radio" name="selectedclub" value="yes" checked="checked">��
<input type="radio" name="selectedclub" value="no">�ƴϿ�  <input type="submit" value="����">
</div>
